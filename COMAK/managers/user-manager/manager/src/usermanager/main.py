...
class MainWidget(QtGui.QWidget, Ui_MainWidget):
    ...
    def checkBackend(self):
        ...
        if not len(self.iface.getPackages()):
           # kdeui.KMessageBox.error(self,i18n("There are no packages that provide backend for this application.\nPlease make sure that packages are installed and configured correctly."))
    ...
    def slotItemDelete(self):
        ...
        if widget.getType() == "user":
            ...
            if self.userLoggedOn(username):
               ...
               #ctx.askForAction(None,'sistem zaten bu kullanıcı ile baglısın','Adam ol','Adam ol dedik ya')
            ...
            # KMessageBox'lı şeklinde soruyo Qt'ye çevrilecek burası.
            # if kdeui.KMessageBox.questionYesNo(self,i18n("Do you want to delete group '%1'?", groupname)) == kdeui.KMessageBox.Yes:
            dialog=DialogQuestion(self)
           ...
           # reply=QtGui.QMessageBox.question(self,i18n("Do you want to delete group '%1'?",groupname)) == QtGui.QMessageBox.Yes,QtGui.QMessageBox.No
           # if reply==QtMessageBox.No :
           #     return
