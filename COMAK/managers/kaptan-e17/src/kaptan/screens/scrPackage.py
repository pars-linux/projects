...
class Widget(QtGui.QWidget, Screen):
    ...
    def __init__(self, *args):
        ...
        self.flagRepo = 0
        self.repoName = "enlightenment-repo"
        self.repoAddress ="http://x86-64.comu.edu.tr/enlightenment/%s/pisi-index.xml.xz" % platform.machine()
        ...
        # control if we already have enlightenmentn repo
