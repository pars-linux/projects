...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrAvatar.ui on Tue Feb  8 14:58:32 2011
#
...
"border: 4px solid gray;"))
    ...
    def retranslateUi(self, Form):
        ...
        self.description.setText(kdecore.i18n("This screen helps you set your <b>user picture</b>. You can either choose an image from a file or you can capture an image from your camera. Select an option from the <b>options</b> menu."))
        self.comboBox.setItemText(0, kdecore.i18n("Options"))
        self.comboBox.setItemText(1, kdecore.i18n("Choose an image"))
        self.takeButton.setText(kdecore.i18n("Capture"))
        self.takeAgainButton.setText(kdecore.i18n("Recapture"))
