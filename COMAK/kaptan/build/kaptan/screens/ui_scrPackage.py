...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrPackage.ui on Tue Feb  8 14:58:31 2011
#
...
"}"))
        ...
        self.updateInterval.setProperty(_fromUtf8("value"), 2)
...
"border-top-right-radius: 4px;"))
    ...
    def retranslateUi(self, packageWidget):
        ...
        self.description.setText(kdecore.i18n("To install and remove programs to Pardus, use Package-Manager. Package-Manager also can automatically install the latest updates available. You can set the period for checking new updates."))
        self.label.setText(kdecore.i18n("Updates"))
