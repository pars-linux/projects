...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrSummary.ui on Tue Feb  8 14:58:30 2011
#
...
""))
    ...
    def retranslateUi(self, summaryWidget):
        ...
        self.description.setText(kdecore.i18n("You have successfully finished all steps. Here\'s a summary of the settings you want to apply. Click <b>Apply Settings</b> to save them now. You are now ready to enjoy Pardus!"))
        self.label.setText(kdecore.i18n("The following settings will be applied"))
