...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrGoodbye.ui on Tue Feb  8 14:58:31 2011
#
...
"}"))
    ...
    def retranslateUi(self, goodbyeWidget):
        ...
        self.description.setText(kdecore.i18n("<b>Your settings have been applied.</b> Now you can start enjoying Pardus or you can checkout the following links and applications for more settings or for help and support. Don\'t forget to <b>join our community!</b>"))
        self.label.setText(kdecore.i18n("My Smolt Page"))
        self.buttonSystemSettings_2.setText(kdecore.i18n("My Smolt Page"))
        self.labelSystemSettings_2.setText(kdecore.i18n("Go to your Smolt page and rate your hardware components."))
        self.label_3.setText(kdecore.i18n("System Settings"))
        self.labelSystemSettings.setText(kdecore.i18n("Configuration tools for Pardus such as the display, firewall, keyboard, user manager..."))
        self.buttonSystemSettings.setText(kdecore.i18n("System Settings"))
        self.label_4.setText(kdecore.i18n("Help and Support"))
        self.labelHelpPages.setText(kdecore.i18n("Pardus community, mailing lists, chat rooms, Wiki documents, help and support pages..."))
