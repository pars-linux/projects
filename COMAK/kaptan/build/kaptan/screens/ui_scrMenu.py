...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrMenu.ui on Tue Feb  8 14:58:30 2011
#
...
"}"))
    ...
    def retranslateUi(self, menuWidget):
        menuWidget.setWindowTitle(kdecore.i18n("Menu"))
        self.description.setText(kdecore.i18n("You can also customize your <b>KDE menu</b> as you like. Please choose one from the following styles."))
        self.menuStyles.setItemText(0, kdecore.i18n("Kick-off Menu"))
        self.menuStyles.setItemText(1, kdecore.i18n("Simple Menu"))
        self.menuStyles.setItemText(2, kdecore.i18n("Lancelot Menu"))
        self.labelMenuDescription.setText(kdecore.i18n("Sample"))
