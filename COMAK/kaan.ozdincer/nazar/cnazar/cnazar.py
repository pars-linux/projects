...
class SystemTrayIcon(QtGui.QSystemTrayIcon, QWidget):
    ...
    def __init__(self,icon, parent=None):
        ...
        menu.addSeparator()
        menu.addAction(QIcon("/usr/share/cnazar/data/help-about.png"), unicode("Hakkında"), self.about)
        menu.addSeparator()
        menu.addAction(QIcon("/usr/share/cnazar/data/application-exit.png"), unicode("Çıkış"), self.exit)
