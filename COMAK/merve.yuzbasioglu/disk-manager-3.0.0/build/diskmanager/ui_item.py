...
class Ui_ItemWidget(object):
    def setupUi(self, ItemWidget):
        ...
        self.labelDescription.setStyleSheet(_fromUtf8("color:rgba(0,0,0,140);"))
    ...
    def retranslateUi(self, ItemWidget):
        self.checkState.setToolTip(i18n("Mount or unmount disk."))
        self.pushEdit.setToolTip(i18n("Edit"))
        self.pushDelete.setToolTip(i18n("Delete"))
