...
class MainWidget(QtGui.QWidget, Ui_MainWidget):
    ...
    def checkBackend(self):
        ...
        if not len(self.iface.getPackages()):
            QtGui.QMessageBox.warning(self, i18n("There are no packages that provide backend for this application.\nPlease make sure that packages are installed and configured correctly."))
            return False
        return True
    ...
    def addItem(self, id_, name="", description="", os_type="", default=False):
        ...
        """
        icon = QtGui.QIcon("drive-harddisk")
        type_ = os_type
    ...
    def slotItemDelete(self):
        ...
        """
        widget = self.sender()
        answer=QtGui.QMessageBox.question(self,i18n("Do you want to delete '%1'?",widget.getTitle()),QtGui.QMessageBox.Yes,QtGui.QMessageBox.No)
