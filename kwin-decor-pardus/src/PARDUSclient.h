...
#ifndef PARDUSCLIENT_H
#define PARDUSCLIENT_H
...
class PARDUSClient : public KDecoration
{
    Q_OBJECT
public:
    PARDUSClient(KDecorationBridge* bridge, KDecorationFactory* factory);
    ~PARDUSClient();
...
private:
    ...
    PARDUSButton *m_button[NumButtons];
