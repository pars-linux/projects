...
# 
# $Id: listtests.py,v 1.1.1.1 2001/10/31 18:11:05 mholloway Exp $
...
def suite():
    ...
    # that can be made from the ListTestCase class using its 'check*'
    # functions.
    suite1 = unittest.makeSuite(ListTestCase, 'check')
    # Same with UserListTestCase, which subclasses ListTestCase; the 'check*'
    # methods in the base class will be found
    suite2 = unittest.makeSuite(UserListTestCase, 'check')
