...
// preparing smarty
$smarty->assign("fasafiso_signature","<a href=\"http://fasafiso.org/\" title=\"FasaFiso v{$config['fasafiso']['version']} ({$config['fasafiso']['builddate']})\">FasaFiso v{$config['fasafiso']['version']}</a>");
